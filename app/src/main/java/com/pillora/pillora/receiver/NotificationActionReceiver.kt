...
import com.pillora.pillora.workers.HandleNotificationActionWorker // Criaremos este worker
...
class NotificationActionReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        Log.d("ActionReceiver", "Ação '${intent.action}' recebida para lembreteId: $lembreteId")
